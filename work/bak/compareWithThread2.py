...
class ExcelComparer(QWidget):
    ...
    #
    #     file_select_layout.addWidget(self.sheet_label1)
    #     file_select_layout.addWidget(self.sheet_combo1)
    #     file_select_layout.addWidget(self.sheet_label2)
    #     file_select_layout.addWidget(self.sheet_combo2)
    #
    #     # 主键选择控件
    ...
    def initUI(self):
        ...
        left_layout.addWidget(self.sheet_label2)
        left_layout.addWidget(self.sheet_combo2)
        left_layout.addWidget(self.primary_key_label)
        left_layout.addWidget(self.primary_key_list)
        ...
        # 顶部水平布局
        top_layout.addLayout(left_layout, 2)  # 左侧布局占比2
        top_layout.addLayout(right_layout, 1)  # 右侧布局占比1
    ...
    def on_sheet_names_loaded(self, file_path, sheet_names):
        ...
        if file_path == self.file1:
            ...
            if sheet_names:
                self.sheet_combo1.setCurrentText(sheet_names[0])
        elif file_path == self.file2:
            self.sheet_combo2.clear()
            self.sheet_combo2.addItems(sheet_names)
            if sheet_names:
                self.sheet_combo2.setCurrentText(sheet_names[0])
